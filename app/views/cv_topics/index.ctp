<div class="cvTopics index">
<h2><?php __('CvTopics');?></h2>
<p>
<?php
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $cvTopic['CvTopic']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action'=>'edit', $cvTopic['CvTopic']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action'=>'delete', $cvTopic['CvTopic']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $cvTopic['CvTopic']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
